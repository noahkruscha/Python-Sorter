...
def switch_event():
    print("loggong_switch toggled, current value:", logging_switch_var.get()) 
...
loggong_switch = customtkinter.CTkSwitch(master=tabview.tab("Einstellungen"),
                                         text="erstelle logs", 
                                         command=switch_event,
                                         variable=logging_switch_var, 
                                         onvalue="on", 
                                         offvalue="off")
loggong_switch.grid(row=4, column=4, padx=0, pady=0)
